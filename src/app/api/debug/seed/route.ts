    ...
    try {
        ...
        if (catalogCount === 0) {
            await prisma.rewardCatalog.createMany({
                data: [
                    { name: 'Amazon Coupon $10', description: 'Digital code for shopping', pointsRequired: 100, rewardType: 'voucher', regionId, isActive: true },
                    { name: 'Premium Coffee', description: 'Starbucks Gift Card', pointsRequired: 50, rewardType: 'voucher', regionId, isActive: true },
                    { name: 'Team Lunch', description: 'Voucher for team meal', pointsRequired: 200, rewardType: 'voucher', regionId, isActive: true },
                    { name: 'Day Off', description: 'Extra PTO day', pointsRequired: 500, rewardType: 'physical', regionId, isActive: true },
                ]
            })
        }
