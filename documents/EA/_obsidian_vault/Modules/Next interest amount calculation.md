...
# 📋 Next interest amount calculation
...
- System finds all not fully paid  installment parts type interest with installment due date <= next installment due date.  If no such a installment part exists, calculation result is null and calculation ends.
	
- System calculates next interest amount as sum of unpaid amount of all installment parts found in previous step.
