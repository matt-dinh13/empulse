...
- → Realisation: [[{ADD}15.101 Revert Canceled contract (Requirement 1838358)]]
- → UseCase «include»: [[{ADD}15.100 Change contract status (UseCase 1838375)]]
- ← UseCase «include»: [[{ADD}15.103 Revert Canceled contract to Active (UseCase 1838367)]]
- ← UseCase «include»: [[{ADD}15.104 Revert Canceled contract to Paid-off (UseCase 1838370)]]
- ← UseCase «include»: [[{ADD}15.102 Revert Canceled contract to Signed (UseCase 1838372)]]
