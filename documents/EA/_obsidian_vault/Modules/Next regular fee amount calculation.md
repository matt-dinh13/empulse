...
# 📋 Next regular fee amount calculation
...
- System finds all not fully paid  installment parts type fee for installments with type STANDARD and installment due date <= next installment due date.  If no such a installment part exists, calculation result is null and calculation ends.
	
- System calculates next regular fee amount as sum of unpaid amount of all installment parts found in previous step.
