...
- System finds all not fully paid  installment parts type fee for installments found in previous step.  If no such a installment part exists, calculation result is null and calculation ends.
	
- System calculates next fee amount as sum of unpaid amount of all installment parts found in previous step.
