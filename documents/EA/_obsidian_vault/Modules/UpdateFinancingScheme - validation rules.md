...
# 📋 UpdateFinancingScheme - validation rules
...
// Validation of UpdateFinancingScheme
...
Mandatory
Structure of FinancingSchemeValues is checked by the rule FinancingSchemeValues - validation rules.

## 🔗 Connections (2)

- → Dependency: [[FinancingSchemeValues - validation rules]]
- ← Dependency: [[{DEL}04.403 Update Financing Scheme]]
