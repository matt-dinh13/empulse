...
# 🔷 {DEL}ArchiveCommodityValidationRuleRequest
...
- → Dependency: [[{DEL}ArchiveCommodityValidationRule (Class 1746826)]]
...
| Name | Type | Default |
|------|------|---------|
| commodityValidationRule | {DEL}ArchiveCommodityValidationRule |  |
