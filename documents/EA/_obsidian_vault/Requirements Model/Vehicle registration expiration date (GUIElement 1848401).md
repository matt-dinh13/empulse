...
- LDM source for field pre-filling: CommodityForUpdate.commodity.vehicleRegistrationExpirationDate
	
- LDM for value saving: CommodityUpdate.commodity.vehicleRegistrationExpirationDate
