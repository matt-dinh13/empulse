...
# 📋 {ADD}01.128 Preview contract document with security level 1
...
{ADD CLM-5122/}
This access right allows to preview security restricted contract documents.
Code=UC01_128_FilePreviewContractSL1
