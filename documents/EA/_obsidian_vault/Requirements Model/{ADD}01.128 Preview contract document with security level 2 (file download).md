...
# 📋 {ADD}01.128 Preview contract document with security level 2 (file download)
...
{ADD CLM-2719/}
This access right allows to download security restricted contract documents.
Code=UC01_128_FileDownloadContractSL2
