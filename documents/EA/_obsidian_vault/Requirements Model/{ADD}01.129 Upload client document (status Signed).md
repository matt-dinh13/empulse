...
# 📋 {ADD}01.129 Upload client document (status Signed)
...
Code=UC01_129_Signed

This access right is used with rule Access control to Document by Contract status - user can access documents only in defined contract statuses: Signed.{/ADD}
