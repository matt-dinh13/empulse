...
# 📋 {DEL}Check Customer offers availability on Salesroom
...
{DEL CLM-4648/} -- taken from the original LOR function Check availability of offers on salesroom, created for CLM usage only!
