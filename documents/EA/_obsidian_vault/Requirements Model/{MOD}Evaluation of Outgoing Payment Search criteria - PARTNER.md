...
# 📋 {MOD}Evaluation of Outgoing Payment Search criteria - PARTNER
...
- OutgoingPayment.PaymentChannel.Salesroom.Partner.Code = entered code AddressedToPartner (exact match of string is searched)
...
- ← Dependency: [[Search criteria - PARTNER]]
