...
# 📋 {ADD}01.129 Upload client document (statuses before signing)
...
{ADD CLM-2299}Specific right for UC activation
Code=UC01_129_BeforeSigned

This access right is used with rule Access control to Document by Contract status - user can access documents only in defined contract statuses: Approved.{/ADD}
