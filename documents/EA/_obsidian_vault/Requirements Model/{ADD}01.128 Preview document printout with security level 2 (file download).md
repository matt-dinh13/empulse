...
# 📋 {ADD}01.128 Preview document printout with security level 2 (file download)
...
{ADD CLM-2719/}
This access right allows to download security restricted document printouts.
Code=UC01_128_FileDownloadPrintoutSL2
