...
# 📋 {ADD}01.128 Preview client document with security level 2 (file download)
...
{ADD CLM-2719/}
This access right allows to download security restricted client documents.
Code=UC01_128_FileDownloadClientSL2
