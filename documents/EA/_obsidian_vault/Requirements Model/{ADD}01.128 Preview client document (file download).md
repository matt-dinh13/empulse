...
# 📋 {ADD}01.128 Preview client document (file download)
...
- Code = UC01_128_FileDownloadClient


If the user has this privilege assigned, he/she can download the client document file to own local drive.
