...
# 📋 LOR-9182 - Add validation for Monthly household income field
...
As a sales agent, I need to be prevented from entering a monthly household income lower than (or equal to) 25 000 INR onto the application form, so the MFI regulations for a minimal income of potential applicants for a loan are met that way.
...
- → Realisation: [[LOR-9159 - MFI_Validations for Monthly household income field]]
