...
# 📋 {ADD}01.129 Upload client document (all statuses)
...
Code=UC01_129_AllContractStatuses

This access right is used with rule Access control to Document by Contract status - user can access to documents without any contract-status restrictions.{/ADD}
