...
# 📋 {ADD}01.128 Preview document (status Active)
...
- Code = UC01_128_Active


This access right is used with rule Access control to Document by Contract status - user can access documents in defined contract statuses: Active ('A').
