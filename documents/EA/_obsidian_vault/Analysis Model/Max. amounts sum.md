...
Max sum of payment orders amounts. Found files have sum of amounts of specified currency <= entered value
...
Mandatory: no
Localization code: PAY_OutgoingPaymentAmountSumMax
