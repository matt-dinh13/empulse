...
# 🔷 GetPaymentChannelByBankAccountDataResponse
...
- → Dependency: [[GetPaymentChannelByBankAccountDataResultDto]]
...
| Name | Type | Default |
|------|------|---------|
| foundPaymentChannels | {ADD}PaymentChannelDto |  |
| result | GetPaymentChannelByBankAccountDataResultDto |  |
