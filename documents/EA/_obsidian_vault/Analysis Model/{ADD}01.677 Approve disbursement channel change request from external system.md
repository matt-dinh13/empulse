...
# 🎯 {ADD}01.677 Approve disbursement channel change request from external system
...
{ADD PAYM-5537}
Use case descibes processing of disbursement channel change request based on ticketing event notification.
