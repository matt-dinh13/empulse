...
# 📋 01.168 Reject offers - all applications
...
Extended right allowing the user reject offers of any application regardless the salesroom where the application was created.
Code=UC01_168_AllApplications
