...
Panel containing the detailed information about the content document files associated with particular page defined for respective application document as well as the operational buttons for related operations.
