...
Search input checkbox for controlling, whether the communication records originated in the Loxon (LCS) system shall be displayed in the Communication records grid or they should be filtered out.
...
Checked by default if 'LCS' value is listed within the global parameter CommunicationHistorySelectedSystems.

Localization code:
CommunicationSystem.LCS
