...
LDM Source: 
Temporary_Application->TempAppl_Employment.Employment_Employed_from

Localization code: 
APP_EmploymentLengthYY

*Note: Common label with localization code APP_EMPLOYMENTLENGTH is used this field and Length of empl (MM).

## 🔗 Connections (1)

- ← Generalization: [[Length of empl (YY)]]
