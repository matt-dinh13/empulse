...
- contract -> applicant -> relatedPersonInfos.firstName
...
- GEN_BENEFICIARYCOMPANYNAME1 (for field Target type = BENEFICIARY_COMPANY)
	
- GEN_BENEFICIARYPERSONNAME1 (for field Target type = BENEFICIARY_PERSON)
