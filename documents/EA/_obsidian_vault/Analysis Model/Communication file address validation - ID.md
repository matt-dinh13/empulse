...
# 📋 Communication file address validation - ID
...
Indonesian version of the Communication file address validation
...
else if town was not found, find zip codes by addressType.subDistrict value
