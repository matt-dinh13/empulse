...
# 📋 01.169 Get document content - all applications
...
{DEL LOR-9211/}
Extended right allowing the user get document content of any application regardless the salesroom where the application was created.
Code=UC01_169_AllApplications
