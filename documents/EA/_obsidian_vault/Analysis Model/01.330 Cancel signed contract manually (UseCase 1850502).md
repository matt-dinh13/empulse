...
This use case enables to cancel the contract manually. The contract must be in status signed.
...
- → Realisation: [[01.330 Cancel signed contract manually (all salesrooms)]]
...
- → Realisation: [[01.330 Cancel signed contract manually]]
