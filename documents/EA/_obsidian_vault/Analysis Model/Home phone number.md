...
- Localization Code: MSG_REL_AuthQuestion5

Answer Source
customerPersonGetResponse.foundRole -> partyRole -> phoneNumber.number where abstractContact.classification = 'HOME_PHONE'
