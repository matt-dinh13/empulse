...
Search input checkbox for controlling, whether the communication records originated in the CCH system shall be displayed in the Communication records grid or they should be filtered out.
...
Checked by default if 'CCH' value is listed within the global parameter CommunicationHistorySelectedSystems.

Localization code:
CommunicationSystem.CCH
