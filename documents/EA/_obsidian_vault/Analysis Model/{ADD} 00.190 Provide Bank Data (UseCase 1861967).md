...
This use case describes how BSL prepares and sends Bank data for external systems.

## 🔗 Connections (4)

- → Realisation: [[{ADD} 00.190 Provide Bank Data]]
- → Realisation: [[{ADD} BankManagementWS]]
