...
Other:
Dynamic search - Codelist get based on calling Manufacturers REST API https://{environment}/product-catalog/openapi/v1/manufacturers/active It is possible to store codelist value and also non-codelist value
