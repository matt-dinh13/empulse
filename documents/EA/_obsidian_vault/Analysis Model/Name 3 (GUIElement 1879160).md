...
- contract -> applicant -> relatedPersonInfos.middleName
...
- GEN_BENEFICIARYCOMPANYNAME3 (for field Target type = BENEFICIARY_COMPANY)
	
- GEN_BENEFICIARYPERSONNAME3 (for field Target type = BENEFICIARY_PERSON)
