...
- → Realisation: [[LOR-1341 - Extend the ApplicationManagementWS.GetApplicationDataResponse method with scoring data]]
- → Dependency: [[AdditionalInformation (Class 1819755)]]
