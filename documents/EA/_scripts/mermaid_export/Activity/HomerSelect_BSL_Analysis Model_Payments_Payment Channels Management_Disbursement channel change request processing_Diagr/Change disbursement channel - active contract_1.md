...
flowchart TD
    ...
    node_1825424["Synchronization"]
    Request_for_DCH_change_created_in_BSL["Request for DCH change created in BSL"]
    Change_disbursement_channel_initiated_by_customer(( ))
    ...
    Request_for_DCH_change_created_in_BSL -->|unnamed| node_1825424
    node_1825424 -->|unnamed| Ticket_created_and_assigned_to_BO
    node_1825424 -->|unnamed| Card_is_blocked_for_withdraw
    Ticket_created_and_assigned_to_BO -->|unnamed| node_1825416
    Card_is_blocked_for_withdraw -->|unnamed| node_1825416
    node_1825416 -->|unnamed| Request_payment_channel_checked_by_BO_agent
