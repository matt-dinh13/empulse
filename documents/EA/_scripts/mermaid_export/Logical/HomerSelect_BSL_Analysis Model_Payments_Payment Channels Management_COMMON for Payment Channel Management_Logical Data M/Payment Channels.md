...
classDiagram
    ...
    Disbursement_Channel_Change_Request o-- ADD_External_Card : unnamed
    ...
    MOD_Payment_Channel o-- ADD_External_Card : unnamed
    MOD_Payment_Channel o-- Disbursement_Channel_Change_Request : unnamed
