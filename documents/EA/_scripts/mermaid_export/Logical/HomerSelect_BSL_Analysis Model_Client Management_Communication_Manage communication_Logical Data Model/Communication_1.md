...
classDiagram
    ...
    Communication_Record --> Communication_Event : was recorded during
    ...
    Address --> Communication_Record : unnamed
    ...
    CommunicationRecord2Ticket --> Communication_Record : unnamed
    Communication_Result_Part --> Communication_Record : is composed of
