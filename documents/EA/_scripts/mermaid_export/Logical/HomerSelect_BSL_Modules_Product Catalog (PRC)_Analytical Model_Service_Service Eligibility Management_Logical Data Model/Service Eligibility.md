...
- **Package**: HomerSelect/BSL/Modules/Product Catalog (PRC)/Analytical Model/Service/Service Eligibility Management/Logical Data Model
- **Diagram ID**: 150097
- **Elements**: 9
- **Connectors**: 8
...
classDiagram
    ...
    Service_Eligibility_Container o-- Service_Eligibility_Criteria : unnamed
    ...
    Service_Eligibility_Criteria o-- Service_Eligibility_Criteria_Parameter : unnamed
    ...
    Service_Eligibility_Criteria_Type o-- Service_Eligibility_Criteria_Parameter_Type : unnamed
```
