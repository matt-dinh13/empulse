...
classDiagram
    ...
    TempAppl_2_Document --> MOD_Temporary_Application : unnamed
    ...
    MOD_TempAppl_Document_Photo_Validation --> TempAppl_Document : unnamed
    Validation_Attempt_Detail --> Validation_Attempt : unnamed
    MOD_TempAppl_Document_Photo_Validation --> Validation_Attempt : unnamed
    Document_Photo_Validation --> Validation_Attempt : unnamed
    TempAppl_Document --> Document_Type : unnamed
    TempAppl_Document_Attribute --> TempAppl_Document : unnamed
    TempAppl_DMS_File --> TempAppl_Document : unnamed
