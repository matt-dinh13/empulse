...
classDiagram
    ...
    GetNextInstallmentResponse o-- InstallmentDto : unnamed
    ...
    GetInstallmentScheduleResponse o-- InstallmentDto : unnamed
    GetInstallmentScheduleResponse o-- PaymentDto : unnamed
