...
classDiagram
    ...
    Sales_Quote_Item o-- Account_Transaction : unnamed
    Sales_Quote_Applied o-- Sales_Quote_Item : unnamed
    ...
    Contract_Supplement <|-- Account_Transaction_Supplement : unnamed
