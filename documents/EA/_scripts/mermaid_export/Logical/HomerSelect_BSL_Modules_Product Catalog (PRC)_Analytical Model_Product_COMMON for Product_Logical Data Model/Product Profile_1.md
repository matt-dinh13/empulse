...
classDiagram
    ...
    Product_Profile_Installment_Schedule --> Product_Profile : unnamed
    Product_Profile --> Accounting_Method : unnamed
    Product_Profile --> Product_Type : unnamed
    MOD_Product --> Product_Profile : unnamed
    Product_Profile_2_Application_Form_Configuration --> Product_Profile : unnamed
    Product_Profile_2_Product_Set --> Product_Profile : unnamed
