...
classDiagram
    ...
    Product_Variant <|-- MOD_Standalone_Insurance_Product_Variant : unnamed
    ...
    MOD_Product o-- Product_To_Marketing_Action : unnamed
    MOD_Product o-- Product_To_Commodity_Type : unnamed
    MOD_Product o-- Product_Document_Printout : unnamed
