...
classDiagram
    ...
    Service_Type o-- Service_Type_Flag : unnamed
    ...
    Service o-- Service_To_Eligibility_Container : unnamed
    Service o-- MOD_Subvention : unnamed
    Service o-- Service_To_Document_Type : unnamed
    Service_Relation ..> Service : unnamed
    Service o-- Service_to_qualification_criteria : unnamed
