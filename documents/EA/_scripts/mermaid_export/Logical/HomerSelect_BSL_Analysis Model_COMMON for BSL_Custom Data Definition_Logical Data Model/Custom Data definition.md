...
- **Package**: HomerSelect/BSL/Analysis Model/COMMON for BSL/Custom Data Definition/Logical Data Model
- **Diagram ID**: 100787
- **Elements**: 11
- **Connectors**: 3
...
classDiagram
    ...
    Custom_Data_Definition o-- Custom_Data_Definition_Attribute : unnamed
