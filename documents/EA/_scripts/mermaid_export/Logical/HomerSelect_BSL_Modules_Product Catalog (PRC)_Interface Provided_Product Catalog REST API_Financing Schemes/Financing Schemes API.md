...
classDiagram
    ...
    GET_financing_schemes <|.. financing_schemes : unnamed
    POST_financing_schemes <|.. financing_schemes : unnamed
    PUT_financing_schemes <|.. financing_schemes : unnamed
    DELETE_financing_schemes <|.. financing_schemes : unnamed
    GET_financing_scheme_versions <|.. financing_scheme_versions : unnamed
    PUT_financing_scheme_activations <|.. ADD_financing_scheme_activations : unnamed
