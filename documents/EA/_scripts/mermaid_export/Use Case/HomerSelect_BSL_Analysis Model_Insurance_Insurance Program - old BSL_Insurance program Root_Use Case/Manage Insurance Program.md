...
- **Package**: HomerSelect/BSL/Analysis Model/Insurance/Insurance Program - old BSL/Insurance program Root/Use Case
- **Diagram ID**: 127469
- **Elements**: 21
- **Connectors**: 20
...
graph LR
    ...
    Time --- n_08_590_Activate_Insurance_Program_version_automatically
    User --- n_08_570_Search_for_Insurance_Program
    User --- n_08_530_Create_Insurance_Program_version
    User --- n_08_520_Create_Insurance_Program
    User --- n_08_525_Create_Insurance_Program_by_copy
    User --- n_08_560_Show_Insurance_Program_version_detail
    User --- n_08_580_Activate_Insurance_Program_version_manually
    User --- n_08_540_Cancel_Insurance_Program_version
    User --- n_08_550_Set_main_Insurance_Program_properties
```
