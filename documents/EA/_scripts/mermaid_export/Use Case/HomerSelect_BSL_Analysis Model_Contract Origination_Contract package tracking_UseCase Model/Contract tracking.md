...
- **Package**: HomerSelect/BSL/Analysis Model/Contract Origination/Contract package tracking/UseCase Model
- **Diagram ID**: 152457
- **Elements**: 23
- **Connectors**: 28
...
graph LR
    ...
    n_01_281_Record_contract_package_mistake_v2 --> User
    ...
    n_01_265_Receive_contract_package -.->|include| MOD_05_090_Generate_outgoing_payment_for_contract
    n_01_265_Receive_contract_package -->|unnamed| Access_control_to_Contract_Packages_by_Salesroom_and_Sales_a
    n_01_265_Receive_contract_package -.->|include| n_01_266_Check_presence_of_contract_with_barcode_reader
    ...
    TCK --> n_01_281_Record_contract_package_mistake_v2
    User --- n_01_260_Send_contract_package_to_central_office
    User --- n_01_250_Print_contract_package
    User --- n_01_265_Receive_contract_package
    User --- n_01_230_Show_contract_package_detail
    User --- n_01_200_Add_to_contract_package
    User --- n_01_240_Remove_from_contract_package
    User --- n_01_220_Search_for_contract_package
```
