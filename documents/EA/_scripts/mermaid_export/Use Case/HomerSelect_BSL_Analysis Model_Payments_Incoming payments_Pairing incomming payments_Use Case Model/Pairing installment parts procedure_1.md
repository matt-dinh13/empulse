...
```mermaid
graph TD
    ADD_Supress_due_date_method["{ADD}Supress due date method"]
    ...
    ADD_Supress_due_date_method -->|External Reference| Standard_priority_pairing_method_for_particular_T_C
    ADD_Supress_due_date_method -->|External Reference| DPD_priority_pairing_method_for_particular_T_C
    ADD_Supress_due_date_method -->|External Reference| Highest_DPD_priority_pairing_method_for_particular_T_C
    ADD_Supress_due_date_method -->|External Reference| Highest_DPD_priority_pairing_method
    ADD_Supress_due_date_method -->|External Reference| Standard_priority_pairing_method
    ...
    ADD_Supress_due_date_method -->|External Reference| DPD_priority_pairing_method
    ...
    MOD_05_180_Perform_coupling_payments_with_instalments -->|unnamed| MOD_03_080_Add_installment
