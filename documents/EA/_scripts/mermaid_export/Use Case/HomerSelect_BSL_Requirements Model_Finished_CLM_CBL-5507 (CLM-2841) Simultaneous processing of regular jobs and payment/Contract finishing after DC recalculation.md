...
graph LR
    ...
    ADD_Process_CELAccountBalanceChangedInternalSE -.->|include| n_05_081_Create_small_underpayment
    ...
    ADD_Process_CELAccountBalanceChangedInternalSE -.->|include| DEL_01_712_Finish_contract_on_service_execution
    ...
    MOD_01_384_Finalize_contract_consolidation -.->|include| MOD_01_715_Finish_contract_automatically
```
