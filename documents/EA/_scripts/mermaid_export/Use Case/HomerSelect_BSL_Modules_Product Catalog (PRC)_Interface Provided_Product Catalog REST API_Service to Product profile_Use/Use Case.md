...
- **Package**: HomerSelect/BSL/Modules/Product Catalog (PRC)/Interface Provided/Product Catalog REST API/Service to Product profile/Use Case
- **Diagram ID**: 162964
- **Elements**: 6
- **Connectors**: 6
...
graph LR
    ...
    External_Component --- ADD_GET_service_to_product_profiles
    External_Component --- ADD_DELETE_service_to_product_profiles
    External_Component --- ADD_POST_service_to_product_profiles
```
