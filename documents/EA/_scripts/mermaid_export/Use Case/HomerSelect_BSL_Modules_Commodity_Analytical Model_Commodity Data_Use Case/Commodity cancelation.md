...
graph LR
    ...
    Contract_Management --- ADD_Process_contract_supplement_cancelation_notification
    ...
    Account_Management --- Process_transaction_cancelation_notification
    Process_contract_cancelation_notification -.->|include| Cancel_external_validation
    Loan_Origination --- MOD_Process_application_cancelation_notification
    Contract_Management --- Process_contract_cancelation_notification
    External_System --- Cancel_external_validation
    External_System --- Cancel_external_validation
    Process_transaction_cancelation_notification -.->|include| Cancel_external_validation
    MOD_Process_application_cancelation_notification -.->|include| Cancel_external_validation
