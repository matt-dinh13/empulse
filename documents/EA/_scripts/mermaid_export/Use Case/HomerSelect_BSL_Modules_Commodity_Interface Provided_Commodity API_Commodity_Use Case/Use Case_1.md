...
graph TD
    ...
    External_System -->|unnamed| GET_Commodity
    ...
    External_System -->|unnamed| GET_Commodity_for_update
    External_System -->|unnamed| DELETE_Commodity
    External_System -->|unnamed| PUT_Commodity
    External_System -->|unnamed| POST_Commodity
    External_System -->|unnamed| MOD_POST_Commodity_Validation
