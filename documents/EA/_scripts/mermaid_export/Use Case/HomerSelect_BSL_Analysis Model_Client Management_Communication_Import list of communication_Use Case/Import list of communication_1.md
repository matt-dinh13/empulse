...
graph TD
    ...
    External_system -->|unnamed| n_07_061_Automatic_import_communication_list
    Time -->|unnamed| MOD_07_060_Process_communication_list_file
    User -->|unnamed| n_07_010_Import_communication_list
```
