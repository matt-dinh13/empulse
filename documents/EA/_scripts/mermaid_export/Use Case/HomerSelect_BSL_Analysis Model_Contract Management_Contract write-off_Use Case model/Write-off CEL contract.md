...
graph LR
    ...
    BSL_user --- ADD_Contract_write_off_via_API
    MOD_Contract_write_off -->|unnamed| BSL
    ADD_Contract_write_off_via_API -.->|extend| MOD_Contract_write_off
    n_01_550_Write_off_CEL_contract -.->|include| n_01_502_Pay_off_CEL_contract
    ...
    n_01_550_Write_off_CEL_contract -.->|include| n_03_150_Regenerate_terminated_installment_schedule
    ...
    n_01_550_Write_off_CEL_contract -.->|include| MOD_03_120_Pay_off_installment_schedule
    ...
    Loxon --- n_01_550_Write_off_CEL_contract
```
