...
- **Package**: HomerSelect/BSL/Analysis Model/Contract Management/Contract API providing/Provide contract information/Use case model
- **Diagram ID**: 138771
- **Elements**: 16
- **Connectors**: 16
...
graph LR
    ...
    LAP --- n_01_175_Get_contracts_credit_limit_changes
    LAP --- n_01_173_Get_contracts_for_cross_checks
    External_system --> MOD_01_771_Get_contracts_for_disbursement_service
    External_system --> MOD_01_754_Get_contract_detail
    External_system --> MOD_01_753_Get_contract_list
    External_system --> n_01_767_Get_contracts_created_on_salesroom
    BOOK --> n_01_752_Get_contract_history_for_contract
    BOOK --> n_01_750_Get_contracts_by_client
```
