...
graph LR
    ...
    Time --- n_08_612_Process_bonus_services
    Time --- n_08_613_Request_bonus_service
    System_event --- n_08_611_Create_request_for_bonus_service_processing
    User --- n_08_610_Show_Interest_Back_preview
```
