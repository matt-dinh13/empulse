...
graph TD
    ...
    n_01_792_Set_Document_ProofCheck_service -->|unnamed| External_system
    n_01_791_Set_Document_File_service -->|unnamed| External_system
    ...
    External_system -->|unnamed| n_01_790_Get_Contract_Documents_detail_service
```
