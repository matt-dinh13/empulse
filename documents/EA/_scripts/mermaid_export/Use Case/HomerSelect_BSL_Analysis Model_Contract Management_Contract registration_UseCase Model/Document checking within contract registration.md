...
graph LR
    ...
    n_01_275_Show_registration_tab --- REM
    TCK --> MOD_01_280_Record_document_mistake_v2
    User --> MOD_01_280_Record_document_mistake_v2
    User --> n_01_275_Show_registration_tab
    User --> n_01_272_Check_presence_of_document_with_barcode_reader
```
