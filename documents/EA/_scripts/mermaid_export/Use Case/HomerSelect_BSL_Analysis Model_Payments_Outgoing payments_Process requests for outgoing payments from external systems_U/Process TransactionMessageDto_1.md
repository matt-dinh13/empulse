...
graph TD
    ...
    n_05_700_Process_TransactionMessageDto -->|unnamed| MOD_05_240_Cancel_outgoing_payments
    ...
    BSL -->|unnamed| n_05_700_Process_TransactionMessageDto
    CaBus_AM -->|unnamed| n_05_700_Process_TransactionMessageDto
```
