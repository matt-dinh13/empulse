...
graph TD
    ...
    n_05_361_Create_incoming_payment_on_external_request -->|unnamed| n_05_182_Pair_payment_with_contract
    External_System -->|unnamed| n_05_361_Create_incoming_payment_on_external_request
```
