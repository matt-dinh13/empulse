...
graph TD
    ...
    User -->|unnamed| DEL_02_073_Show_detail_of_subvention_for_product
    User -->|unnamed| DEL_02_643_Remove_subvention_for_product
    User -->|unnamed| DEL_02_070_Show_product_version_detail
    User -->|unnamed| DEL_02_603_Set_subvention_for_product
```
