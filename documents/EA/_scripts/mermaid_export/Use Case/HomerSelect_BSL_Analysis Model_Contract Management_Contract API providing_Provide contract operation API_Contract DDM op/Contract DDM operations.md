...
graph LR
    ...
    External_system --> n_01_779_Get_contract_DDM_service
    External_system --> n_01_778_Cancel_contract_DDM_service
    External_system --> n_01_780_Change_contract_repayment_channel_service
    External_system --> n_01_776_Create_contract_DDM_service
    External_system --> n_01_777_Update_contract_DDM_service
    External_system --> ADD_01_781_Change_contract_DDM_status_service
```
