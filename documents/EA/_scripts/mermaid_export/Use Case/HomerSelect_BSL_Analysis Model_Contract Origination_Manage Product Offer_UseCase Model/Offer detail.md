...
graph LR
    ...
    User --- n_01_156_Adjust_credit_limit
    User --> MOD_01_070_Show_product_offer_detail
    User --> n_08_110_Select_insurance_services
    User --- MOD_01_075_Print_product_offer_detail
    User --- MOD_01_076_Display_preliminary_installment_schedule
    User --- n_01_157_Save_adjusted_offer
    User --- n_01_077_Change_product_offer_parameters
```
