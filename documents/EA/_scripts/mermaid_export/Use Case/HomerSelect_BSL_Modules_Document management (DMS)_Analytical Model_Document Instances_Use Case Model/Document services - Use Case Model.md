...
- **Package**: HomerSelect/BSL/Modules/Document management (DMS)/Analytical Model/Document Instances/Use Case Model
- **Diagram ID**: 164540
- **Elements**: 18
- **Connectors**: 21
...
graph LR
    ...
    ADD_14_042_Delete_Document_Attribute --> External_system
    Cabinet --> n_14_090_Upload_file_to_file_storage
    ...
    External_system --> MOD_14_010_Create_Document
    MOD_14_012_Patch_Document --> External_system
    ...
    MOD_14_010_Create_Document -.->|include| n_14_090_Upload_file_to_file_storage
