...
graph TD
    ...
    Collection_system -->|unnamed| n_01_410_Pay_off_contract_manually
    Loyalty_program -->|{ADD}| n_01_410_Pay_off_contract_manually
    User -->|unnamed| n_01_410_Pay_off_contract_manually
    CaBus_AM -->|unnamed| n_01_410_Pay_off_contract_manually
```
