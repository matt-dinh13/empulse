...
graph TD
    ...
    External_system -->|unnamed| n_11_050_Get_Insurance_Program_detail_service_v2
    External_system -->|unnamed| n_11_202_Get_insurance_custom_data_definition_service_v2
    External_system -->|unnamed| n_11_200_Get_Insurance_Programs_service
    External_system -->|unnamed| n_11_204_Get_Insurance_Eligibility_definition_service
    External_system -->|unnamed| n_11_124_Validate_data_eligibility_for_insurance
```
