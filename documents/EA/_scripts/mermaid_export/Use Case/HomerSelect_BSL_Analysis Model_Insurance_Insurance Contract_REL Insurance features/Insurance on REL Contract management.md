...
graph LR
    ...
    n_08_072_Change_insurance_operation_status -.->|include| n_11_149_Deactivate_insurance_on_contract
    ...
    User --> n_08_340_Show_Insurance_offers_for_loan_contract
    User --> n_08_072_Change_insurance_operation_status
