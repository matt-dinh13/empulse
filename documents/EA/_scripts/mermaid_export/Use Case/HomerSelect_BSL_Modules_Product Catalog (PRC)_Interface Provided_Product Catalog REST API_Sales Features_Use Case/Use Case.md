...
- **Package**: HomerSelect/BSL/Modules/Product Catalog (PRC)/Interface Provided/Product Catalog REST API/Sales Features/Use Case
- **Diagram ID**: 160594
- **Elements**: 8
- **Connectors**: 11
...
graph LR
    ...
    External_Component --- GET_data_for_product_calculator
    External_Component --- POST_marketing_offer_availability
```
