...
graph LR
    ...
    MOD_01_427_Change_DDM_ECS_provider --> User
    ...
    MOD_01_425_Update_DDM -.->|include| MOD_01_668_Create_request_for_change_disbursement_channel
    ...
    User --> MOD_01_425_Update_DDM
    User --> MOD_01_430_Receive_DDM
    User --> n_01_420_Create_DDM_on_the_contract
    User --> n_01_421_Create_application_DDM
    User --> n_01_426_Cancel_DDM
