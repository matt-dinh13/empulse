...
- **Package**: HomerSelect/BSL/Analysis Model/Payments/Payment Channels Management/Refunds disbursement channel management/Use Case Model
- **Diagram ID**: 155826
- **Elements**: 7
- **Connectors**: 7
...
graph LR
    ...
    n_05_517_Process_refund_Disbursement_channel_change_request --- TCK
    User --- n_01_663_Edit_refunds_disbursement_channel
    CIF --- n_01_663_Edit_refunds_disbursement_channel
```
