...
graph LR
    ...
    n_09_240_Show_salesroom -.->|include| n_09_250_Find_salesroom
    n_09_230_Update_salesroom -->|unnamed| Selection_of_process_type_and_2BoD_filling
    User --- n_09_220_Create_salesroom
    User --- n_09_230_Update_salesroom
    User --- n_09_350_Move_salesroom
    User --- n_09_260_Change_salesroom_status_manually
    User --> n_09_240_Show_salesroom
    User --> n_09_215_Set_payment_status_for_Salesroom_manually
    User --- n_09_250_Find_salesroom
```
