...
graph LR
    ...
    n_11_020_Add_insurance_period -.->|include| MOD_11_120_Terminate_insurance_contract
    ...
    n_11_081_Prolong_insurance_contracts --> CaBus_AM
    n_11_081_Prolong_insurance_contracts -->|unnamed| Create_business_event
    n_11_081_Prolong_insurance_contracts -.->|include| MOD_05_091_Generate_outgoing_payment_insurance
    ...
    n_11_081_Prolong_insurance_contracts -.->|include| n_11_126_Check_client_eligibility_for_insurance
    n_11_081_Prolong_insurance_contracts -.->|include| n_11_020_Add_insurance_period
    n_11_081_Prolong_insurance_contracts -->|unnamed| Determine_next_insurance_period
    User --> n_01_050_Change_insurance_prolongation
    Time --> n_11_081_Prolong_insurance_contracts
```
