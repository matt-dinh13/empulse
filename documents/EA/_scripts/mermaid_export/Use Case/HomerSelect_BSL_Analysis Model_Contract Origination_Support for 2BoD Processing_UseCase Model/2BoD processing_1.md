...
graph TD
    ...
    User -->|unnamed| n_01_031_Release_assigned_contract
    User -->|unnamed| MOD_01_210_Show_contract_detail
    User -->|unnamed| n_01_027_Switch_contract_2BoD_queue_type
    User -->|unnamed| n_01_325_Cancel_In_Pre_Process_or_In_Process_contract_manual
    User -->|unnamed| n_01_083_Fill_in_application_2BoD
    User -->|unnamed| n_01_032_Reschedule_2BoD_call
    ...
    n_01_033_Show_2BoD_filling_history -->|unnamed| User
