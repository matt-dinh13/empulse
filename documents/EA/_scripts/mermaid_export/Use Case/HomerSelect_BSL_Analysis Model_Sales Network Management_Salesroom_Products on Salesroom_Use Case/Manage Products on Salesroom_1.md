...
graph TD
    ...
    n_09_271_Import_product_to_salesroom_assignment_file -->|unnamed| n_09_272_Process_product_to_salesroom_assignment_file
    n_09_270_Assign_product_to_salesroom -->|unnamed| Filter_available_products_for_an_assignment_to_salesroom
    User -->|unnamed| n_09_275_Remove_Product_from_Salesroom
    User -->|unnamed| n_09_270_Assign_product_to_salesroom
    User -->|unnamed| n_09_271_Import_product_to_salesroom_assignment_file
```
