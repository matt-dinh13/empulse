...
graph LR
    ...
    BSL --> ADD_01_588_Get_DDM_Data_Exchange_ID
    BSL --> ADD_14_425_Calculate_DDM_limit_via_WS
    BSL --- ADD_14_426_Update_DDM_Document
    BSL --> ADD_14_424_Change_DDM_status_via_WS
    MOD_14_422_Update_DDM_via_WS --> BSL
    ...
    MOD_14_423_Cancel_DDM_via_WS --> BSL
    ...
    n_14_661_Change_repayment_channel_via_WS --> BSL
    ...
    MOD_14_421_Create_DDM_via_WS --> BSL
