...
graph TD
    ...
    External_Component -->|unnamed| MOD_PUT_tariff_activations
    External_Component -->|unnamed| DELETE_tariffs
    External_Component -->|unnamed| MOD_PUT_tariffs
    External_Component -->|unnamed| GET_tariff_items
    External_Component -->|unnamed| GET_tariff_versions
    External_Component -->|unnamed| GET_tariffs
    External_Component -->|unnamed| MOD_POST_tariffs
```
