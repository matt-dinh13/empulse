...
- **Package**: HomerSelect/BSL/Analysis Model/Contract Management/Outgoing payments operations on contract/Use Case Model
- **Diagram ID**: 164531
- **Elements**: 8
- **Connectors**: 9
...
graph LR
    ...
    n_05_092_MOD_Disburse_outgoing_payments_manually -.->|include| MOD_05_090_Generate_outgoing_payment_for_contract
    ...
    User --> MOD_05_093_Allow_payments_for_a_contract
    User --> n_05_092_MOD_Disburse_outgoing_payments_manually
    User --> MOD_05_094_Block_payments_for_a_contract
```
