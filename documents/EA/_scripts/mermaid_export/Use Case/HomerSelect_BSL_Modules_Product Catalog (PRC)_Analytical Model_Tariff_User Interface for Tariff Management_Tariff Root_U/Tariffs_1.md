...
graph TD
    ...
    Time -->|unnamed| n_04_190_Activate_Tariff_version_automatically
    User -->|unnamed| DEL_04_015_Create_Tariff_by_copy
    User -->|unnamed| DEL_04_070_Show_Tariff_version_detail
    User -->|unnamed| DEL_04_170_Cancel_Tariff_version
    User -->|unnamed| DEL_04_010_Create_Tariff
    User -->|unnamed| DEL_04_060_Set_main_Tariff_properties
    User -->|unnamed| DEL_04_180_Activate_Tariff_version_manually
    User -->|unnamed| DEL_04_160_Create_Tariff_version
    User -->|unnamed| DEL_04_090_Search_for_Tariffs
    User -->|unnamed| DEL_04_090_Search_for_Tariffs
```
