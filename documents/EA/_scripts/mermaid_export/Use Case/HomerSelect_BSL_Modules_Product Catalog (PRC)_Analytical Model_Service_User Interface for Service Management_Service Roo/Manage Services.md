...
- **Package**: HomerSelect/BSL/Modules/Product Catalog (PRC)/Analytical Model/Service/User Interface for Service Management/Service Root/Use Case Model
- **Diagram ID**: 162293
- **Elements**: 21
- **Connectors**: 23
...
graph LR
    ...
    Time --- n_08_190_Activate_Service_version_automatically
    User --- DEL_08_125_Create_Service_by_copy
    User --- DEL_08_160_Show_Service_version_detail
    User --- DEL_08_150_Set_main_Service_properties
    User --- DEL_08_130_Create_Service_version
    User --- DEL_08_180_Activate_Service_version_manually
    User --- DEL_08_170_Search_for_Services
    User --- DEL_08_140_Cancel_Service_version
    User --- DEL_08_120_Create_Service
```
