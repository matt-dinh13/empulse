...
graph TD
    ...
    Time -->|unnamed| n_05_270_Process_DDS_requests_file
    CaBus_AM -->|unnamed| n_05_273_Process_DDS_requests_message
    External_system -->|unnamed| n_05_263_Get_DDS_export_status
```
