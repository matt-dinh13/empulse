...
- **Package**: HomerSelect/BSL/Modules/Product Catalog (PRC)/Analytical Model/Tariff/Provided Services/Use case
- **Diagram ID**: 162650
- **Elements**: 4
- **Connectors**: 4
...
graph LR
    ...
    External_Component --- DEL_04_300_Provide_Tariff_Data
    External_Component --- DEL_04_310_Provide_List_of_Tariff_Versions
```
