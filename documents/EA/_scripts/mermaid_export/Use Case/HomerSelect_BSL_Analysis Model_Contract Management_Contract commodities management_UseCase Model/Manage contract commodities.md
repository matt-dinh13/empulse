...
- **Package**: HomerSelect/BSL/Analysis Model/Contract Management/Contract commodities management/UseCase Model
- **Diagram ID**: 161692
- **Elements**: 14
- **Connectors**: 23
...
graph LR
    ...
    User --- n_01_650_Edit_Contract_Commodity
    User --- MOD_01_210_Show_contract_detail
    User --- MOD_01_655_Validate_contract_Commodity
    User --- ADD_01_650_Edit_Contract_Commodity_CLM
```
