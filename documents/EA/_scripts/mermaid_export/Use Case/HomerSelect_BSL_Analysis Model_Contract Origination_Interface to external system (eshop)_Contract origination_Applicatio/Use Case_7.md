...
graph TD
    ...
    n_01_385_Assign_card_to_application_externally -->|unnamed| External_system
    External_system -->|unnamed| n_01_311_Update_offer_to_application_and_evaluate
    External_system -->|unnamed| n_01_096_Prepare_documentation_externally
    External_system -->|unnamed| n_01_312_Update_approved_application
    External_system -->|unnamed| n_01_097_Cancel_application_externally
    External_system -->|unnamed| n_01_095_Create_and_evaluate_application
    External_system -->|unnamed| n_01_040_Get_application_data
    External_system -->|unnamed| MOD_01_310_Update_application_v9
    External_system -->|unnamed| n_01_164_Search_for_application
    External_system -->|unnamed| MOD_01_098_Update_and_evaluate_application_v9
    External_system -->|unnamed| n_01_313_Evaluate_application
```
