...
Service offer - validation"]
    ...
    External_Component -->|unnamed| GET_service_relations
    External_Component -->|unnamed| MOD_PUT_service_activations
    External_Component -->|unnamed| MOD_POST_services
    External_Component -->|unnamed| PUT_service_relations
    External_Component -->|unnamed| GET_service_versions
    External_Component -->|unnamed| DELETE_services
    External_Component -->|unnamed| MOD_GET_services
    External_Component -->|unnamed| MOD_PUT_services
    External_Component -->|unnamed| MOD_POST_service_offers
```
