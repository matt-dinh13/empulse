...
graph TD
    ...
    User["User"]
    External_system -->|unnamed| n_01_673_Save_card_data_to_external_module_for_contract
    ...
    MOD_PAYM_6304_01_676_Verify_bank_account_data_for_contract_d -->|unnamed| Bank_account_Management
    ...
    User -->|unnamed| n_01_675_Verify_card_data_in_external_module_for_contract
    User -->|unnamed| MOD_01_210_Show_contract_detail
    User -->|unnamed| MOD_PAYM_6304_01_676_Verify_bank_account_data_for_contract_d
    User -->|unnamed| MOD_01_662_Change_disbursement_channel
    External_system -->|unnamed| n_01_675_Verify_card_data_in_external_module_for_contract
