...
- **Package**: HomerSelect/BSL/Analysis Model/Contract Management/Contract financial partnership/Use case model
- **Diagram ID**: 147412
- **Elements**: 14
- **Connectors**: 15
...
graph LR
    ...
    MOD_01_186_Prepare_documentation -->|unnamed| Update_contract_financial_partnership_algorithm
    n_01_096_Prepare_documentation_externally -.->|include| MOD_01_186_Prepare_documentation
