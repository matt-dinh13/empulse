...
graph TD
    ...
    n_04_100_Add_charging_requests -->|unnamed| n_04_110_Process_charging_requests
    n_04_110_Process_charging_requests -->|unnamed| MOD_Charging_request_content_validation
    External_system -->|unnamed| n_04_123_Automatic_add_charging_requests
    User -->|unnamed| n_04_100_Add_charging_requests
```
