...
classDiagram
    ...
    AF2_INS --> Ins_Co_bank : unnamed
    Post_main --> Post_main_bank_acc : unnamed
    Ins_Co_bank --> Ins_Co_bank_acc : unnamed
    Partner_bank --> Partner_bank_acc : unnamed
    AF2_PTR --> POS1 : unnamed
    AF1_CL --> Post_main : unnamed
    AF3_CL --> Client_bank_acc : unnamed
    AF3_CL --> Client_bank : unnamed
    Client_bank --> Client_bank_acc : unnamed
    Partner_bank --> F234 : unnamed
    Client_bank --> F234 : unnamed
    POS1 --> F345 : unnamed
    F234 --> HC_bank_acc : unnamed
    F345 --> HC_bank_acc : unnamed
    AF4_CL --> Partner_bank : unnamed
    AF2_PTR --> POS_1 : unnamed
    AF4_CL --> CL : unnamed
    AF3_CL --> CL : unnamed
    AF2_PTR --> PTR : unnamed
    AF2_INS --> INS : unnamed
    Post_Branch_1 --> Post_CL_Retailer : unnamed
    Post_main_bank_acc --> Post_CL_Retailer : unnamed
    POS1 --> POS1_bank_acc : unnamed
    POS_1 --> Retailer_1 : unnamed
    AF1_CL --> CL : unnamed
    POS1_bank_acc --> POS_1 : unnamed
    Bank_branch_1 --> Partner_bank_1 : unnamed
    Partner_bank_acc --> Partner_bank_1 : unnamed
    AF4_CL --> Bank_branch_1 : unnamed
    Ins_Co_bank_acc --> Insurance_Co_1 : unnamed
