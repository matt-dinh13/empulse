...
classDiagram
    ...
    Financing_Package_Criteria_D --> Financing_Package_iPhone_8 : unnamed
    Financing_Package_Criteria_B --> Financing_Package_iPhone_8 : unnamed
    Financing_Package_Criteria_C --> Financing_Package_iPhone_8 : unnamed
    Financing_Package_Criteria_A2 --> Financing_Package_iPhone_8 : unnamed
    Product_BETA --> Financing_Package_iPhone_8 : unnamed
    Financing_Package_iPhone_8 --> Financing_Scheme_HIGH_BUDGET : unnamed
    Financing_Package_Criteria_E --> Financing_Package_iPhone_8 : unnamed
    Financing_Scheme_Variant_1 --> Financing_Scheme_LOW_BUDGET : unnamed
    ...
    FS_Initial_Payment_1 --> Financing_Scheme_LOW_BUDGET : unnamed
    Financing_Scheme_Variant_2 --> Financing_Scheme_LOW_BUDGET : unnamed
    Financing_Package_Criteria_A1 --> Financing_Package_iPhone_8 : unnamed
```
