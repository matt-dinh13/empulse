...
- **Diagram Type**: Custom
- **Package**: HomerSelect/BSL/Analysis Model/Contract Management/Contract detail/Show contract detail/User Interface Model/Tab-Client
- **Diagram ID**: 157678
- **Elements**: 24
- **Connectors**: 2
...
graph TD
    ...
    View_and_download_stored_document["View and download stored document"]
