...
```mermaid
graph TD
    ADD_Insurance_subject_type["{ADD}Insurance subject type"]
    ...
    DEL_Insured_subject_type["{DEL}Insured subject type"]
    ...
    Set_main_Insurance_program_properties -->|unnamed| n_08_550_Set_main_Insurance_Program_properties
    OK -->|unnamed| User_Interface_Show_Insurance_Program
    Cancel -->|unnamed| User_Interface_Show_Insurance_Program
```
